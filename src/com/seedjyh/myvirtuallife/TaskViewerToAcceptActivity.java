...
public class TaskViewerToAcceptActivity extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_task_viewer_to_accept);
	...
	private void Init()
	{
		...
		accept_button_click_listener = new Button.OnClickListener(){
	...
	{
		Log.i("test", "Bind");
		((Button)findViewById(R.id.button_id_task_viewer_to_accept_accept)).setOnClickListener(accept_button_click_listener);
	...
	//==========================================================================================
	// listener
	private Button.OnClickListener accept_button_click_listener;
